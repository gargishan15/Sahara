...
const Appointment = () => {
  ...
  try {
    ...
    let day = selectedSlot.dateTime.getDate();
    let month = selectedSlot.dateTime.getMonth() + 1;
    let year = selectedSlot.dateTime.getFullYear();
    ...
    <div>
      <div className='flex flex-col sm:flex-row gap-4 '>
        ...
        <div className='flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
          ...
          <div className='flex items-center gap-2 text-2xl text-sm mt-1 text-gray-600'>
